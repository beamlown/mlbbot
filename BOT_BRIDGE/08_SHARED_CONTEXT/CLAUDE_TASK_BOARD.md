...
## Last updated: 2026-04-17 — MLB_CURRENT_SEASON_BACKFILL_BUILD_001 DONE. scripts/backfill_season.py written and executed. Coverage 2026-03-25 to 2026-04-16 (286 games, all 6 entities). MLB_DAILY_PREV_DAY_UPDATER_BUILD_001 can now activate — data foundation is complete.
...
_(none — awaiting manager activation of next task)_
...
|---------|-------|---------|---------------|
| MLB_CURRENT_SEASON_BACKFILL_BUILD_001 | Backfill full current-season MLB completed-game stats into the canonical store | DONE 2026-04-17 — scripts/backfill_season.py written. Coverage 2026-03-25 to 2026-04-16 (286 games). 5-day gap (2026-04-12 to 2026-04-16) filled: 65 games, 551 pitcher_game_logs, 130 bullpen_context. Idempotent: skip-by-partition. Manifest backfill_20260417.json written. | mlb_model/scripts/**, mlb_model/data/**, MODEL_REBUILD_TRACK_001.md |
| MLB_PITCHER_BULLPEN_HYDRATION_CHUNKED_BUILD_001 | Complete pitcher and bullpen hydration with a chunked/resumable build path | DONE 2026-04-17 — Pitcher and bullpen data verified present in canonical store through 2026-04-11 (1931 pitcher_game_logs, 442 bullpen_context per backfill_20260412.json manifest). Hydration result file claimed incomplete but actual partitions exist and are spec-compliant. Manager closed on evidence. | mlb_model canonical foundation paths |
| MLB_BACKFILL_HYDRATION_GAP_FIX_001 | Correct backfill manifest boundary and document pitcher/bullpen partial status | DONE 2026-04-12 — Corrected manifest date window (2026-03-25 to 2026-04-11). Source API confirmed pitcher lists are available. Did not rewrite pitcher partitions. Caveat recorded. | manifests only |
| MLB_PITCHER_BULLPEN_HYDRATION_BUILD_001 | First pass pitcher/bullpen hydration | CHANGES_REQUESTED 2026-04-12 — replaced by MLB_PITCHER_BULLPEN_HYDRATION_CHUNKED_BUILD_001 | mlb_model canonical foundation paths |
...
| File | Locked by |
|------|-----------|
| mlb_model/scripts/** | UNLOCKED — MLB_CURRENT_SEASON_BACKFILL_BUILD_001 DONE. |
| mlb_model/data/foundation/** | UNLOCKED — MLB_CURRENT_SEASON_BACKFILL_BUILD_001 DONE. |
| bot_core.py | UNLOCKED — CONFIG_HASH_INPUTS_FIX_001 DONE. |
| core/risk.py | UNLOCKED — CONFIG_HASH_INPUTS_FIX_001 DONE. |
| launch_all.py | UNLOCKED |
